    ...
    <div className="flex flex-col h-full">
      <div className="flex-1 flex flex-col justify-center items-center px-4">
        <div className="max-w-[400px]">
          ...
          <p className="mb-2">Request to join us, <a className="text-blue-600 hover:text-blue-800" href="https://chat.whatsapp.com/DMqsymB8YmFD5za7R9IdwO" target="_blank" rel="noopener noreferrer">here</a>.</p>
